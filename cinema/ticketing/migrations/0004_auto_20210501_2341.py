# Generated by Django 2.2.1 on 2021-05-01 19:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cinema',
            name='capacity',
            field=models.IntegerField(default=100, verbose_name='ظرفیت'),
        ...
        migrations.AlterField(
            model_name='showtime',
            name='free_seats',
            field=models.IntegerField(verbose_name='تعداد باقی\u200cمانده'),
        ),
        migrations.AlterField(
            model_name='showtime',
            name='movie',
        ...
        migrations.AlterField(
            model_name='showtime',
            name='saleable_seats',
            field=models.IntegerField(verbose_name='تعداد قابل فروش'),
        ),
        migrations.AlterField(
            model_name='showtime',
            name='start_time',
        ...
        migrations.AlterField(
            model_name='showtime',
            name='status',
            field=models.IntegerField(choices=[(1, 'فروش شروع نشده '), (2, 'درحال فروش بلیط'), (3, 'بلیط تمام شد'), (4, 'فروش بلیط بسته شده '), (5, 'فیلم پخش شد'), (6, 'سانس لغو شد')], verbose_name='وضعیت'),
        ),
    ]
